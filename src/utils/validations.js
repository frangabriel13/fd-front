...
export const editManufacturerValidator = ({ name, owner, phone, minPurchase, pointOfSale, street, tiktokUrl, instagramNick, description }) => {
  ...
  if(description && (typeof description !== 'string' || description.length < 3 || description.length > 500)) {
    errors.description = 'La descripción del fabricante debe tener entre 3 y 500 caracteres';
  }
