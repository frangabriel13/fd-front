...
const CreateReview = ({ manufacturerId, onClose, onSubmit }) => {
      ...
      <div className={s.modalContent}>
        <div className={s.container}>
          <div className={s.divTitle}>
            <h3>Mi review</h3>
            <p>Califica al fabricante y deja un comentario.</p>
          </div>
          <form className={s.form} onSubmit={handleSubmit}>
            ...
            <div className={s.divBtn}>
              ...
              <button type="submit" className={s.btnSubmit}>Enviar</button>
            </div>
          </form>
        </div>
      </div>
